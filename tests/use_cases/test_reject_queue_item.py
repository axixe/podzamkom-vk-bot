...
class RejectQueueItemUseCaseTest(unittest.TestCase):
    def test_rejects_in_review_item(self) -> None:
        ...
        use_case = RejectQueueItemUseCase(
    ...
    def test_raises_business_error_for_non_in_review(self) -> None:
        repository = InMemoryUserDraftRepository()
        repository.seed_queue(
            [
                PhotoQueueItemForReview(
